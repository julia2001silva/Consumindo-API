        		...
        		<div class="row mb-5">
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Endereço:</span>Rua Marechal Deodoro da Fonseca, 132 - Centro, São Roque - SP, 18130-070</p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Telefone</span> <a href="tel://1234567920"> (11) 4712-3229</a></p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Email:</span> <a href="mailto:info@yoursite.com">info@carapi.com</a></p>
			          </div>
		          </div>
		        </div>
          </div>
...
<script data-storemapper-start='2023,05,18'
        data-storemapper-id='20670-0KAOznjKlNb5hM37'>
        ...
        ());
            ...
            <!-- <script>
            navigator.geolocation.getCurrentPosition(function(posicao) { alert(posicao.coords.latitude + ', ' + posicao.coords.longitude); });
          </script> -->
            </div>
        </div>
      </div>
